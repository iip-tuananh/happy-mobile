...
<div class="topbar ">
    <div class="container">
        <div class="row">
            <div class="col-lg-6 col-md-12 col-12 contact-header">
                <span class="time">
            ...
            <div class="col-lg-6 d-lg-block d-none menu-top">
                ...
                <nav class="header-nav">
                    <ul class="item_big">
                      @foreach ($categoryProduct as $cate)
                            ...
                            <li class="nav-item ">
                                <a class="a-img caret-down" href="{{route('allListProCate',['cate'=>$cate->slug])}}" >
                                    {{languageName($cate->name)}}
                                </a>
                                <i class="fa fa-caret-down"></i>
                                <ul class="item_small">
                                    @foreach ($cate->typeCate  as $type)
                                    <li>
                                        <a class="" href="{{route('allListProType',['cate'=>$cate->slug,'type'=>$type->slug])}}" title="  {{languageName($type->name)}}">
                                            {{languageName($type->name)}}
                                        </a>
                                    </li>
                                    @endforeach
