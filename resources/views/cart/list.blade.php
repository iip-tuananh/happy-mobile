                  ...
                  <div class="col-lg-12 col-12 col-cart-left">
                     ...
                     <div class="cart-mobile-page d-block d-xl-none">
                        <div class="CartMobileContainer">
                           <form novalidate="" class="cart ajaxcart cart-mobile">
                              @php
                              $totalPrice = 0 ;
                              @endphp
                              @foreach ($cartcontent as $item)
                              ...
                              <div class="ajaxcart__inner ajaxcart__inner--has-fixed-footer cart_body">
                                 <div class="ajaxcart__row">
                                    <div class="ajaxcart__product cart_product" data-line="1">
                                       <a href="/iphone-13-pro-max-128gb" class="ajaxcart__product-image cart_image" title="{{languageName($item['name'])}}"><img width="80" height="80" src="{{$item['image']}}" alt="{{languageName($item['name'])}}"></a>
                                       <div class="grid__item cart_info">
                                          <div class="ajaxcart__product-name-wrapper cart_name">
                                             <a href="/iphone-13-pro-max-128gb" class="ajaxcart__product-name h4" title="{{languageName($item['name'])}}">{{languageName($item['name'])}}</a>
                                             <span class="ajaxcart__product-meta variant-title">{{$item['color']}}</span>
                                          </div>
                                          <div class="grid">
                              ...
                              <div class="ajaxcart__footer ajaxcart__footer--fixed cart-footer">
                                 ...
                                 <div class="cart__btn-proceed-checkout-dt">
                                    <button href="{{route('checkout')}}" type="button" class="button btn btn-default cart__btn-proceed-checkout" id="btn-proceed-checkout" title="Thanh toán">Thanh toán</button>
                                 </div>
                              </div>
                           </form>
                        </div>
