         ...
         <article class="article-main">
            <div class="row">
               <div class="right-content col-lg-9 col-12">
                  <div class="article-details clearfix">
                     ...
                     <div class="posts">
                        <div class="time-post f">
						   ...
						   {{date('d-m-Y', strtotime($blog_detail->updated_at))}}
                        </div>
                        <div class="time-post">
                  ...
                  {{-- <form method="post"
                     action="/posts/top-phu-kien-dong-gia-duoi-500k-sieu-xin-tai-nd-tech-tong-xa-kho-uu-dai-cuc-to/comments"
                     ...
                     <input name="FormType" type="hidden"
                        ...
                        id="Token-8e247f9784cd41e789b2371b9fa00472" name="Token" />
                     ...
                     <script>
                        grecaptcha.ready(function() {
                            grecaptcha.execute("6Ldtu4IUAAAAAMQzG1gCw3wFlx_GytlZyLrXcsuK", {
                                ...
                                document.getElementById("Token-8e247f9784cd41e789b2371b9fa00472").value = token
                            });
                        });
                     </script>
            ...
            <div class="clearfix blog_lienquan">
               <h2 class="block-title">
                  <a href="#" title="Tin liên quan">Tin Khác</a>
               </h2>
               <div class="clearfix">
